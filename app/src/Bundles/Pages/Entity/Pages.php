...
class Pages
{
     ...
     * Set user
     *
     * @param \Agora\Bundles\Entities\Entity\Entities $user
     *
     * @return Pages
     */
    public function setUser(\Agora\Bundles\Entities\Entity\Entities $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Agora\Bundles\Entities\Entity\Entities
     */
